...
public class GlobalExceptionHandler {
    ...
    // 입고서 예외 핸들러
    @ExceptionHandler(InputWarehouseException.class)
    public ResponseEntity<ApiResponse<?>> handleInputWarehouseException(InputWarehouseException e, HttpServletRequest request){
